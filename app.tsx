...
// Source: SARS "New Transfer Duty rates effective 1 April 2025" and SARS Transfer Duty tax rates page (2025).
//  - From 1 Apr 2025 (applies to 2026 tax year):
const TD_2025APR = [
...
function transferDuty(amount:number, acquisitionDateISO:string){
  ...
  // Use threshold 2025-04-01 inclusive for new schedule
...
// Deeds Office fee schedules (effective 1 Apr 2025). Amounts are ZAR. Source: deeds.gov.za Fees Schedule.
  ...
  return (
    <label className="grid gap-1">
      ...
      <div className="flex rounded-xl border border-neutral-700 focus-within:ring-2 focus-within:ring-red-500/20 overflow-hidden">
        <input inputMode="decimal" className="w-full p-3 outline-none bg-neutral-900 text-white" value={Number.isFinite(value) ? value : 0}
...
function PercentInput(props: Omit<Parameters<typeof NumberInput>[0],"suffix">){
  return <NumberInput {...props} suffix="%" step={0.01}/>;
}

function CurrencyInput(props: Omit<Parameters<typeof NumberInput>[0],"suffix">){
  return <NumberInput {...props} suffix="R" step={1000}/>;
}

// -----------------------------
// Main Component
// -----------------------------
const LOGO_SRC = "KW Explore_White.png"; // place this image in your public/assets folder
const KW_RED = "#E31837"; // KW brand red (adjust if needed)
const KW_RED_DARK = "#B5122B";

// -----------------------------
// August 2025 Guideline Tables (from uploaded PDF)
// Values are rounded totals including VAT and levies where noted.
// -----------------------------
const TRANSFER_GUIDELINE_AUG2025 = [
  { value: 100000, total: 11119 },
  { value: 200000, total: 13865 },
  { value: 250000, total: 15819 },
  { value: 300000, total: 17160 },
  { value: 350000, total: 18680 },
  { value: 400000, total: 20021 },
  { value: 450000, total: 21362 },
  { value: 500000, total: 22703 },
  { value: 550000, total: 25296 },
  { value: 600000, total: 25296 },
  { value: 650000, total: 28258 },
  { value: 700000, total: 28258 },
  { value: 750000, total: 30851 },
  { value: 800000, total: 30851 },
  { value: 850000, total: 33634 },
  { value: 900000, total: 33634 },
  { value: 950000, total: 36227 },
  { value: 1000000, total: 36227 },
  { value: 1100000, total: 39002 },
  { value: 1200000, total: 39002 },
  { value: 1300000, total: 44295 },
  { value: 1400000, total: 47295 },
  { value: 1500000, total: 52889 },
  { value: 1600000, total: 55889 },
  { value: 1700000, total: 62568 },
  { value: 1800000, total: 68568 },
  { value: 1900000, total: 77161 },
  { value: 2000000, total: 83161 },
  { value: 2100000, total: 92389 },
  { value: 2200000, total: 98389 },
  { value: 2300000, total: 106983 },
  { value: 2400000, total: 114397 },
  { value: 2500000, total: 124990 },
  { value: 2600000, total: 132990 },
  { value: 2700000, total: 143583 },
  { value: 2800000, total: 151583 },
  { value: 2900000, total: 162176 },
  { value: 3000000, total: 170332 },
  { value: 3500000, total: 233112 },
  { value: 4000000, total: 293299 },
  { value: 4500000, total: 356564 },
  { value: 5000000, total: 416751 },
  { value: 6000000, total: 522278 },
  { value: 7000000, total: 650335 },
  { value: 8000000, total: 766862 },
  { value: 9000000, total: 883946 },
  { value: 10000000, total: 1000474 },
];

const BOND_GUIDELINE_AUG2025 = [
  { bond: 250000, total: 15819 },
  { bond: 300000, total: 17160 },
  { bond: 350000, total: 18680 },
  { bond: 400000, total: 20021 },
  { bond: 450000, total: 21362 },
  { bond: 500000, total: 22703 },
  { bond: 550000, total: 25296 },
  { bond: 600000, total: 25296 },
  { bond: 650000, total: 28258 },
  { bond: 700000, total: 28258 },
  { bond: 750000, total: 30851 },
  { bond: 800000, total: 30851 },
  { bond: 850000, total: 33634 },
  { bond: 900000, total: 33634 },
  { bond: 950000, total: 36227 },
  { bond: 1000000, total: 36227 },
  { bond: 1100000, total: 39002 },
  { bond: 1200000, total: 39002 },
  { bond: 1300000, total: 41595 },
  { bond: 1400000, total: 41595 },
  { bond: 1500000, total: 44189 },
  { bond: 1600000, total: 44189 },
  { bond: 1700000, total: 46782 },
  { bond: 1800000, total: 46782 },
  { bond: 1900000, total: 49375 },
  { bond: 2000000, total: 49375 },
  { bond: 2100000, total: 52603 },
  { bond: 2200000, total: 52603 },
  { bond: 2300000, total: 55197 },
  { bond: 2400000, total: 55197 },
  { bond: 2500000, total: 57790 },
  { bond: 2600000, total: 57790 },
  { bond: 2700000, total: 60383 },
  { bond: 2800000, total: 60383 },
  { bond: 2900000, total: 62976 },
  { bond: 3000000, total: 62976 },
  { bond: 3500000, total: 70756 },
  { bond: 4000000, total: 75943 },
  { bond: 4500000, total: 84208 },
  { bond: 5000000, total: 89395 },
  { bond: 6000000, total: 95922 },
  { bond: 7000000, total: 102979 },
  { bond: 8000000, total: 109506 },
  { bond: 9000000, total: 116590 },
  { bond: 10000000, total: 123118 },
];

const EARNINGS_GUIDELINE_AUG2025 = [
  { installment: 5076, income: 18000 },
  { installment: 5584, income: 19000 },
  { installment: 6091, income: 22000 },
  { installment: 6599, income: 24000 },
  { installment: 7107, income: 26000 },
  { installment: 7614, income: 27000 },
  { installment: 8122, income: 29000 },
  { installment: 8629, income: 30000 },
  { installment: 9137, income: 35000 },
  { installment: 9645, income: 35500 },
  { installment: 10152, income: 36000 },
  { installment: 11168, income: 40000 },
  { installment: 12183, income: 45000 },
  { installment: 13198, income: 50000 },
  { installment: 14213, income: 53000 },
  { installment: 15228, income: 54000 },
  { installment: 16244, income: 60000 },
  { installment: 17259, income: 65000 },
  { installment: 18274, income: 70000 },
  { installment: 19289, income: 73000 },
  { installment: 20305, income: 75000 },
  { installment: 21320, income: 77000 },
  { installment: 22335, income: 87000 },
  { installment: 23350, income: 85000 },
  { installment: 24365, income: 90000 },
  { installment: 25381, income: 95000 },
  { installment: 26396, income: 98000 },
  { installment: 27411, income: 100000 },
  { installment: 28426, income: 103000 },
  { installment: 29442, income: 105000 },
  { installment: 30457, income: 110000 },
  { installment: 35533, income: 130000 },
  { installment: 40609, income: 145000 },
  { installment: 45685, income: 165000 },
  { installment: 50761, income: 180000 },
  { installment: 60914, income: 215000 },
  { installment: 71066, income: 255000 },
  { installment: 81218, income: 290000 },
  { installment: 91371, income: 325000 },
  { installment: 101523, income: 365000 },
];

function getTransferGuidelineTotal(price:number){
  const rows = TRANSFER_GUIDELINE_AUG2025;
  if(!rows.length) return 0;
  let chosen = rows[0];
  for(const r of rows){ if(price >= r.value) chosen = r; else break; }
  return chosen.total;
}
function getBondGuidelineTotal(bond:number){
  const rows = BOND_GUIDELINE_AUG2025;
  if(!rows.length) return 0;
  let chosen = rows[0];
  for(const r of rows){ if(bond >= r.bond) chosen = r; else break; }
  return chosen.total;
}
function getRecommendedIncomeFromPmt(installment:number){
  const rows = EARNINGS_GUIDELINE_AUG2025;
  if(installment <= rows[0].installment) return rows[0].income;
  for(let i=1;i<rows.length;i++){
    const a = rows[i-1], b = rows[i];
    if(installment <= b.installment){
      const t = (installment - a.installment) / (b.installment - a.installment);
      return Math.round(a.income + t*(b.income - a.income));
    }
  }
  return rows[rows.length-1].income;
}
...
function MCToolkit(){
  ...
  const [targetDTI, setTargetDTI] = useState(0.30); // 30% of gross by default

  // Duty/fees state
  const [acqDate, setAcqDate] = useState<string>(new Date().toISOString().slice(0,10));
  const [includeVAT, setIncludeVAT] = useState(true);
  const vatRate = 0.15;
  const [initiationFee, setInitiationFee] = useState(6037); // user-editable
  const [useGuidelines, setUseGuidelines] = useState(true);
  // Quick page extras (for first-page layout)
  const [attBondFee, setAttBondFee] = useState(12900);
  const [attTransferFee, setAttTransferFee] = useState(41500);
  ...
  // Affordability (very simplified – user picks target DTI)
          ...
          <div className="max-w-3xl mx-auto">
            <Card title="">
              ...
              <div className="grid gap-4">
                ...
                <button className="w-32 px-4 py-2 rounded-xl font-medium bg-red-600 text-white">Calculate</button>
              </div>
                ...
                <div className="p-3 rounded-xl bg-neutral-800 text-sm">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="text-right">
                      <input type="number" className="w-32 p-2 rounded-lg border border-neutral-700 bg-neutral-900 text-white text-right" value={initiation} onChange={e=>setInitiationFee(Number(e.target.value))} />
                    </div>
